...
//-----------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        //START OF THE LONG CLICK PROCESS ON THE TEXT INPUT FIELD
        ViewInteraction composeText = onView(
                allOf(withId(R.id.embedded_text_editor), withContentDescription("Message composition"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        composeText.perform(longClick());


        //ASSERT THAT THE "hello" MESSAGE IS DISPLAYED ON THE TEXT INPUT FIELD WITHOUT HAVING TO CLICK ON THE KEYBOARD
